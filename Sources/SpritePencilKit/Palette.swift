...
public struct Palette: Equatable {
    ...
    public static let sweetie16 = Palette(name: "Sweetie 16", special: nil, colors: {
        let rgb: [(r: CGFloat, g: CGFloat, b: CGFloat)] = [(26, 28, 44),(93, 39, 93),(177, 62, 83),(239, 125, 87),(255, 205, 117),(167, 240, 112),(56, 183, 100),(37, 113, 121),(41, 54, 111),(59, 93, 201),(65, 166, 246),(115, 239, 247),(244, 244, 244),(148, 176, 194),(86, 108, 134),(51, 60, 87)]
        return rgb.map({ UIColor(red: $0.r/255, green: $0.g/255, blue: $0.b/255, alpha: 1) })
    }())
    ...
    public static var palettes: [Palette] {
        return [Palette.rrggbb, Palette.hhhhssbb, Palette.rrrgggbb, Palette.endesga32, Palette.endesga64, Palette.zughy32, Palette.sp16, Palette.sweetie16, Palette.rct] + customPalettes
    }
